 public with sharing class githubapitest {
    ...
    public static void createRep(String rname,String rdes,Boolean opt){
       // System.debug('Name:::'+rname+'Descrip:::'+rdes+'sfflafla'+opt);
        ...
        String token='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 ';
...
//....................................................................................
   @AuraEnabled(cacheable=true)
    public static List<String> getPathNameMethod(){
        ...
        String endpoint='https://api.github.com/repos/myAPI9071/Basic-info/git/trees/master?recursive=1';
        String token='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 ';
...
public static String getContent(String path){
    String endpoint='https://api.github.com/repos/myAPI9071/Basic-info/contents/'+path;
    String token='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 ';
    HttpRequest req1=new HttpRequest();
    req1.setEndpoint(endpoint);
    req1.setMethod('GET');
